<template>
    <div>
        ...
        <div>
            ...
            <mu-list>
                <mu-sub-header>访问项目在 GitHub 上的源码</mu-sub-header>
                <mu-paper>
                        <mu-list-item title="GitHub" href="https://github.com/liaoxiaoyu/Vue-Douban.git">
                        <mu-icon slot="left" value="link"/>
                        </mu-list-item>
                </mu-paper>
                <mu-sub-header>联系我</mu-sub-header>
                <mu-paper>
                        <mu-list-item :title="'1179595077@qq.com'">
                            <mu-icon slot="left" value="email"/>
                        </mu-list-item>
                        <mu-list-item :title="'中山大学新华学院'">
